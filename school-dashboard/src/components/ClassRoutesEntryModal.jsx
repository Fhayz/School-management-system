...
import ClassResultsEntryModal from "./ClassResultsEntryModal";
...
function ClassTable() {
  ...
  const [selectedClassIdForResults, setSelectedClassIdForResults] = useState(null);
  ...
  // For Results Entry modal
  const openResultsModal = (record) => {
    setSelectedClassIdForResults(record.id);
  ...
  const actionCol = {
    ...
    render: (text, record) => (
      <Space>
        ...
        <Button type="dashed" onClick={() => openResultsModal(record)}>
          Enter Results
        </Button>
      </Space>
    ),
  ...
  return (
    <div>
      ...
      <ClassAttendanceModal
        ...
        reloadClass={fetchClasses}
      />
      <ClassResultsEntryModal
        classId={selectedClassIdForResults}
